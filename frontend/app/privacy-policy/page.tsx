    ...
    <div className="py-12 px-6 text-left ml-40 w-1/2 text-wrap">
      ...
      <div className="text-2xl mb-8">
        ...
        <p>
          ...
          If you have any questions about this Privacy Policy, please contact us at support@transactionclassifier.com
        </p>
      </div>
      ...
      <div className="text-2xl mb-8">
        ...
        <p className="mb-4">
          <strong>3. Use of Service</strong><br />
        ...
        <p className="mb-4">
          <strong>4. Restrictions</strong><br />
          You agree not to:<br />
          - Use the service for any illegal activities.<br />
          - Attempt to disrupt or interfere with the service.<br />
          - Reverse engineer or attempt to extract the source code of the service.
        </p>
        <p className="mb-4">
          <strong>5. Modifications to the Service</strong><br />
        ...
        <p>
          ...
          If you have any questions about these Terms, please contact us at support@transactionclassifier.com
        </p>
      </div>
      <Link
        href="/"
